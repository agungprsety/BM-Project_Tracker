-- =================================================================================
-- SIGIMARGA - PHASE 4: USER FINGERPRINTS (Audit Trail)
-- Run this AFTER Phase 1, 2, and 3 have been applied.
-- =================================================================================
...
-- 2. UPDATE SYNC RPC TO POPULATE FINGERPRINTS
CREATE OR REPLACE FUNCTION sync_project_complete(
  p_project     JSONB,
  p_boq_items   JSONB DEFAULT '[]'::jsonb,
  p_weekly_reports JSONB DEFAULT '[]'::jsonb,
...
BEGIN
  ...
  INSERT INTO projects (
    ...
    created_by, created_by_email, updated_by_email
  ) VALUES (
    v_project_id,
    p_project->>'name',
  ...
  DELETE FROM weekly_reports  WHERE project_id = v_project_id;
